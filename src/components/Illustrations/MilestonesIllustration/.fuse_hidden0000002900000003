            ...
            >
              ...
              <div className="mi__xb">
                <div className="mi__col-hdr">
                  <span className="mi__cl" style={{ flex: 1 }}>
                    Test plan name
                  </span>
                  <span className="mi__cl" style={{ width: '100px', textAlign: 'center' }}>
                    Covered / Total
                  </span>
                  <span style={{ width: '24px', flexShrink: 0 }} />
                  <span className="mi__cl" style={{ width: '112px', textAlign: 'left' }}>
                    Coverage
                  </span>
                </div>
                ...
                <div className="mi__pr-row">
                  ...
                  >
                    <div className="mi__bar-track">
                      <div className="mi__bar-fill mi__bar-fill--2" />
                    </div>
                    <span
                      style={{
                        width: '32px',
                ...
                <div className="mi__pr-row">
                  ...
                  >
                    <div className="mi__bar-track">
                      <div className="mi__bar-fill mi__bar-fill--3" />
                    </div>
                    <span
                      style={{
                        width: '32px',
                ...
                <div className="mi__pr-row">
                  ...
                  >
                    <div className="mi__bar-track">
                      <div className="mi__bar-fill mi__bar-fill--4" />
                    </div>
                    <span
                      style={{
                        width: '32px',
                ...
                <div className="mi__pr-row">
                  ...
                  >
                    <div className="mi__bar-track">
                      <div className="mi__bar-fill mi__bar-fill--5" />
                    </div>
                    <span
                      style={{
                        width: '32px',
