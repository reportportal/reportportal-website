        ...
        <div className="np tcl__nav">
          <div className="tcl__nav-logo">
            <svg width="22" height="22" viewBox="0 0 40 40" fill="none" aria-hidden="true">
              <path d="M3.6875 23.3938L3.6875 28.4657C3.6875 28.8475 3.89868 29.2002 4.2415 29.3911L19.446 37.8568C19.7888 38.0477 20.2112 38.0477 20.554 37.8568L35.7585 29.3911C36.1013 29.2002 36.3125 28.8475 36.3125 28.4657V21.6471L20 30.7622L10.3355 25.3811L10.3355 19.6923L3.6875 23.3938Z" fill="white" />
              <path d="M20 9.23781L29.6645 14.6189V20.3933L36.3125 16.6918V11.5343C36.3125 11.1525 36.1013 10.7998 35.7585 10.6089L20.554 2.14316C20.2112 1.95228 19.7888 1.95228 19.446 2.14316L4.2415 10.6089C3.89869 10.7998 3.6875 11.1525 3.6875 11.5343L3.6875 18.4711L20 9.23781Z" fill="white" />
            </svg>
          </div>
          ...
          <div className="ni"><div className="tcl__nav-bar" /></div>
          <div className="ni"><div className="tcl__nav-bar" /></div>

          <div className="ni on">
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none" aria-hidden="true">
              <rect x="1.5" y="1.5" width="11" height="11" rx="2" stroke="#00D4F0" strokeWidth="1.2" />
              <path d="M4 7L6 9L10 5" stroke="#00D4F0" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
          ...
          <div className="tcl__row">
            ...
            <div className="fp tcl__folders">
              <div className="tcl__folders-hd">
                <span style={{ fontSize: '11px', fontWeight: 800, color: 'var(--text-primary)' }}>Folders</span>
              </div>
              <div className="tcl__folders-body">
                <div className="fo fr"><span className="tcl__arrow">▶</span><span className="tcl__folder-name">UI Login Flow</span></div>
                <div className="fo fr"><span className="tcl__arrow">▼</span><span className="tcl__folder-name">API Regression</span></div>
                <div className="fo fr tcl__folder--l1"><span className="tcl__arrow">▼</span><span className="tcl__folder-name">Auth Service</span></div>
                <div className="fo fr tcl__folder--l2"><span className="tcl__folder-name">Login Tests</span></div>
                <div className="fo fr tcl__folder--l2"><span className="tcl__arrow">▶</span><span className="tcl__folder-name">Token Refresh</span></div>
                <div className="fo fr tcl__folder--l1"><span className="tcl__arrow">▶</span><span className="tcl__folder-name">User Profile</span></div>
                <div className="fo fr"><span className="tcl__arrow">▼</span><span className="tcl__folder-name">Cart Feature</span></div>
                <div className="fo fr tcl__folder--l1"><span className="tcl__folder-name">Add to Cart</span></div>
                <div className="fo fr tcl__folder--l1"><span className="tcl__folder-name">Checkout Flow</span></div>
                <div className="fo fr"><span className="tcl__arrow">▶</span><span className="tcl__folder-name">Performance Tests</span></div>
                <div className="fo fr"><span className="tcl__arrow">▶</span><span className="tcl__folder-name">Security Checks</span></div>
                <div className="fo fr"><span className="tcl__arrow">▶</span><span className="tcl__folder-name">Legacy V1</span></div>
              </div>
            </div>
            ...
            <div className="lp tcl__list">
              <div className="tcl__list-hd">
                <span style={{ fontSize: '11px', fontWeight: 800, color: 'var(--text-primary)' }}>All test cases</span>
              </div>
              <div className="tcl__list-body">
                ...
                <div className="card tr">
                  <div className="tcl__case-row">
                    <svg width="14" height="14" viewBox="0 0 14 14" fill="none" className="tcl__case-icon" aria-hidden="true">
        ...
        <div className="dp tcl__detail">
          ...
          <div className="d1 tcl__detail-hd">
            <div className="tcl__detail-hd-row">
              ...
              <div className="tcl__detail-close" aria-hidden="true">×</div>
            </div>
          </div>
          ...
          <div className="tcl__detail-body">
            ...
            <div className="d3">
              ...
              <div className="tcl__scenario">
                ...
                <div className="tcl__scenario-text">
                  User is logged out. Browser cache is cleared. Valid credentials exist in the system.
                </div>
              </div>
            </div>
            ...
            {/* Attachments */}
            <div className="d4">
              <div className="sl">Attachments <span className="tcl__attach-count">2</span></div>
              <div className="tcl__attachments">
                <div className="ac">
                  <div className="tcl__attach-icon tcl__attach-icon--blue">
                    <svg width="12" height="13" viewBox="0 0 12 13" fill="none" aria-hidden="true">
                      <rect x=".5" y=".5" width="11" height="12" rx="2" stroke="#5577FF" strokeWidth=".9" />
                      <path d="M2.5 4.5h7M2.5 7h5" stroke="#5577FF" strokeWidth=".8" strokeLinecap="round" />
                    </svg>
                  </div>
                  <div>
                ...
                <div className="ac">
                  <div className="tcl__attach-icon tcl__attach-icon--green">
                    <svg width="12" height="13" viewBox="0 0 12 13" fill="none" aria-hidden="true">
                      <rect x=".5" y=".5" width="11" height="12" rx="2" stroke="#00B884" strokeWidth=".9" />
                      <path d="M2.5 4.5h7M2.5 7h5M2.5 9.5h3.5" stroke="#00B884" strokeWidth=".8" strokeLinecap="round" />
                    </svg>
                  </div>
                  <div>
              ...
              <div className="tcl__steps">
                <div className="tcl__step">
                  ...
                  <div className="sc">
                    ...
                    <div className="tcl__step-expected">Expected: Login page renders with form fields visible.</div>
                  </div>
                </div>
                <div className="tcl__step">
                  ...
                  <div className="sc">
                    ...
                    <div className="tcl__step-expected">Expected: Fields accept input without errors.</div>
                  </div>
                </div>
                <div className="tcl__step">
                  ...
                  <div className="sc">
                    ...
                    <div className="tcl__step-expected">Expected: User is redirected to dashboard.</div>
                  </div>
                </div>
              </div>
            </div>
