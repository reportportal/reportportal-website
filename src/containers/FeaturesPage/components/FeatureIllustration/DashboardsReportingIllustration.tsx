...
export const DashboardsReportingIllustration: FC = () => {
  ...
  return (
    <div ref={inViewRef} className="dr-illustration">
      <div ref={containerRef} className="dr-illustration__inner">
        <div
          ref={canvasRef}
        ...
        >
          ...
          <div className="dr-hdr">
            ...
            <div className="dr-add-btn">
              <svg width="11" height="11" viewBox="0 0 11 11" fill="none">
                <path d="M5.5 1v9M1 5.5h9" stroke="white" strokeWidth="1.3" strokeLinecap="round" />
              </svg>
              Add Widget
            </div>
          </div>
          ...
          <div className="dr-body">
            ...
            <div className="dr-kpi-row">
              <div className="dr-kpi">
                <span className="dr-kpi-lbl">Total Launches</span>
                <div className="dr-kpi-bottom">
              ...
              <div className="dr-kpi">
                <span className="dr-kpi-lbl">Passing Rate</span>
                <div className="dr-kpi-bottom">
              ...
              <div className="dr-kpi">
                <span className="dr-kpi-lbl">Test Failures To Investigate</span>
                <div className="dr-kpi-bottom">
            ...
            <div className="dr-charts-row">
              ...
              <div className="dr-widget dr-area-w">
                ...
                <div style={{ flex: 1, minHeight: 0 }}>
                  ...
                  >
                    <defs>
                      <linearGradient id="dr-ag" x1="0" y1="0" x2="0" y2="1">
                        <stop offset="0%" stopColor="#009DBB" stopOpacity=".2" />
                        <stop offset="100%" stopColor="#009DBB" stopOpacity="0" />
                      </linearGradient>
                      <clipPath id="dr-cc">
                        <rect x="26" y="2" width="360" height="96" />
                      </clipPath>
                    </defs>
                    ...
                    <line x1="26" y1="96" x2="384" y2="96" stroke="#DCE9F0" strokeWidth=".5" />

                    <g clipPath="url(#dr-cc)">
                      <path
                        className="dr-chart-area"
                        d="M28,79 C47,79 66,55 87,55 C110,55 124,59 146,59 C168,59 184,33 205,33 C227,33 244,43 264,43 C284,43 301,6 323,6 C343,6 360,22 382,22 L382,96 L28,96 Z"
                        fill="url(#dr-ag)"
                      />
                      <path
                        className="dr-chart-path"
                        d="M28,79 C47,79 66,55 87,55 C110,55 124,59 146,59 C168,59 184,33 205,33 C227,33 244,43 264,43 C284,43 301,6 323,6 C343,6 360,22 382,22"
                        stroke="#009DBB"
                        strokeWidth="2"
                        fill="none"
                      />
              ...
              {/* DONUT */}
              <div className="dr-widget dr-donut-w">
                <div className="dr-w-title">Overall Statistics</div>
                <div className="dr-donut-body">
                  ...
                  <div className="dr-d-leg">
                    <div className="dr-d-li">
                      <div className="dr-d-dot dr-d-dot--pass" />
                      <span>Passed</span>
                    </div>
                    <div className="dr-d-li">
                      <div className="dr-d-dot dr-d-dot--fail" />
                      <span>Failed</span>
                    </div>
                    <div className="dr-d-li">
                      <div className="dr-d-dot dr-d-dot--skip" />
                      <span>Skipped</span>
                    </div>
                    <div className="dr-d-li">
                      <div className="dr-d-dot dr-d-dot--empty" />
                      <span>To run</span>
                    </div>
                  </div>
                </div>
            ...
            {/* TABLE */}
            <div className="dr-tbl-w">
              <div className="dr-tw-top">
                <span className="dr-tw-ttl">Top Flaky Tests</span>
                <span className="dr-tw-link">View all →</span>
              </div>
              <div className="dr-tw-cols">
                <span className="dr-tw-ch">Test Name</span>
                <span className="dr-tw-ch dr-tw-ch--r">Switches</span>
                <span />
                <span className="dr-tw-ch">% of Switches</span>
                <span />
              </div>
              <div className="dr-tw-rows">
