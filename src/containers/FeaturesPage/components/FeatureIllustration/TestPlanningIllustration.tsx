      ...
      <div ref={containerRef} className="test-planning-illustration__inner">
        ...
        >
          ...
          >
            ...
            />
            <div className="ms-illu-nb">
              <div
                style={{
                  width: '12px',
                  height: '10px',
                  borderRadius: '2px',
                  background: 'rgba(200,220,230,0.25)',
                }}
              />
            </div>
            <div className="ms-illu-nb">
            ...
            <div className="ms-illu-nb ms-illu-nb--on">
              <svg width="12" height="13" viewBox="0 0 12 13" fill="none">
                ...
                <path
                  d="M2 1.5h9L8.5 5l2.5 3.5H2V1.5z"
                  fill="rgba(0,212,240,0.18)"
                  stroke="#00D4F0"
                  strokeWidth="1.05"
          ...
          >
            ...
            >
                ...
                <div className="ms-illu-ms-hdr">
                  ...
                  >
                    <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                      <path
                        d="M2 7a5 5 0 015-5 5 5 0 013.5 1.4L12 5"
                        stroke="#8791AB"
                        strokeWidth="1.2"
                        strokeLinecap="round"
                      />
                      <path
                        d="M12 7a5 5 0 01-5 5 5 5 0 01-3.5-1.4L2 9"
                        stroke="#8791AB"
                        strokeWidth="1.2"
                        strokeLinecap="round"
                      />
                      <path
                        d="M10.5 3.5L12 5l-1.8.8"
                        stroke="#8791AB"
                        strokeWidth="1.1"
                        strokeLinecap="round"
                        strokeLinejoin="round"
              ...
              <div
                className="ms-illu-ms-row ms-illu-ms2"
                style={{ border: '0.5px solid #C2DDE8', flexShrink: 0 }}
              >
                <div className="ms-illu-ms-hdr" style={{ background: '#F8FBFD' }}>
                  <span
                    className="ms-illu-chev"
                    style={{ fontSize: '9px', color: '#009DBB', flexShrink: 0 }}
                  >
                    ▶
                  </span>
                  <div
                  ...
                  >
                    <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                      <path
                        d="M7 2s2.5.5 3.5 3.5S10 11 10 11L7 9.5 4 11s-1.5-2.5-.5-5.5S7 2 7 2z"
                        stroke="#009DBB"
                        strokeWidth="1.1"
                        strokeLinejoin="round"
                      />
                ...
                <div className="ms-illu-expand">
                  <div className="ms-illu-col-hdr">
                    <span className="ms-illu-cl" style={{ flex: 1 }}>
                      Test plan name
                    </span>
                    <span className="ms-illu-cl" style={{ width: '100px', textAlign: 'center' }}>
                      Covered / Total
                    </span>
                    <span style={{ width: '24px', flexShrink: 0 }} />
                    <span className="ms-illu-cl" style={{ width: '112px', textAlign: 'left' }}>
                      Coverage
                    </span>
                  </div>
                  <div className="ms-illu-pr-row ms-illu-pr">
                    <span style={{ flex: 1, fontSize: '11px', color: '#2F3C5F', fontWeight: 600 }}>
                    ...
                    <span style={{ width: '24px', flexShrink: 0 }} />
                    <div
                      style={{ display: 'flex', alignItems: 'center', gap: '8px', width: '112px' }}
                    >
                      <div className="ms-illu-bar-track">
                        <div
                          className="ms-illu-bar-fill ms-illu-bf1"
                          style={{ '--bar-w': '78%' } as React.CSSProperties}
                        />
                      </div>
                      <span
                        style={{
                  ...
                  <div className="ms-illu-pr-row ms-illu-pr">
                    ...
                    >
                      <div className="ms-illu-bar-track">
                        <div
                          className="ms-illu-bar-fill ms-illu-bf2"
                          style={
                            { '--bar-w': '100%', background: '#00B884' } as React.CSSProperties
                          }
                        />
                      </div>
                      <span
                  ...
                  <div className="ms-illu-pr-row ms-illu-pr">
                    ...
                    >
                      <div className="ms-illu-bar-track">
                        <div
                          className="ms-illu-bar-fill ms-illu-bf3"
                          style={
                            { '--bar-w': '100%', background: '#00B884' } as React.CSSProperties
                          }
                        />
                  ...
                  <div className="ms-illu-pr-row ms-illu-pr">
                    ...
                    >
                      <div className="ms-illu-bar-track">
                        <div
                          className="ms-illu-bar-fill ms-illu-bf4"
                          style={{ '--bar-w': '32%' } as React.CSSProperties}
                        />
                      </div>
                      <span
                        style={{
                  ...
                  <div className="ms-illu-pr-row ms-illu-pr">
                    ...
                    >
                      <div className="ms-illu-bar-track">
                        <div
                          className="ms-illu-bar-fill ms-illu-bf5"
                          style={{ '--bar-w': '16%' } as React.CSSProperties}
                        />
                      </div>
                      <span
                        style={{
                  ...
                  <div
                    className="ms-illu-ctp"
                    style={{ padding: '10px 16px 10px 32px', borderTop: '0.5px solid #EEF3F8' }}
                  >
                    <span
                      style={{
                        fontSize: '10.5px',
                ...
                <div className="ms-illu-ms-hdr">
                  ...
                  >
                    <svg width="13" height="14" viewBox="0 0 13 14" fill="none">
                      ...
                      />
                      <path
                        d="M2.5 2h8.5L8.5 5.5 11 9H2.5V2z"
                        stroke="#8791AB"
                        strokeWidth="1.1"
                        strokeLinejoin="round"
                      />
                  ...
                  <div
                    className="ms-illu-pill"
                    style={{ background: '#fff', border: '1px solid #C8DDE6', color: '#5F7A8A' }}
                  >
                    Completed
                    <svg width="10" height="10" viewBox="0 0 10 10" fill="none">
                      <path
                ...
                <div className="ms-illu-ms-hdr">
                  ...
                  >
                    <svg width="11" height="14" viewBox="0 0 11 14" fill="none">
                      <path
                        d="M7 1L1.5 7.5H5.5L4 13L9.5 6.5H5.5L7 1Z"
                        stroke="#8791AB"
                        strokeWidth="1.15"
                        strokeLinejoin="round"
                      />
