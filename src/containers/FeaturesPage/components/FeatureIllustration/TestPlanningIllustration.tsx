...
export const TestPlanningIllustration: FC = () => {
  ...
  return (
    <div ref={inViewRef} className="test-planning-illustration">
      <div ref={containerRef} className="test-planning-illustration__inner">
        <div
          ref={canvasRef}
        ...
        >
          ...
          <div style={{ width: '42px', background: '#1C2A40', display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '10px 0', gap: '5px', flexShrink: 0 }}>
            ...
            <div className="ms-illu-nb"><div style={{ width: '12px', height: '10px', borderRadius: '2px', background: 'rgba(200,220,230,0.25)' }} /></div>
            <div className="ms-illu-nb"><div style={{ width: '12px', height: '10px', borderRadius: '2px', background: 'rgba(200,220,230,0.25)' }} /></div>
            <div className="ms-illu-nb"><div style={{ width: '12px', height: '10px', borderRadius: '2px', background: 'rgba(200,220,230,0.25)' }} /></div>
            <div className="ms-illu-nb ms-illu-nb--on">
          ...
          <div style={{ flex: 1, background: '#F5F8FB', display: 'flex', flexDirection: 'column', minWidth: 0, overflow: 'hidden' }}>
            ...
            {/* TITLE BAR */}
            <div className="ms-illu-hdr" style={{ padding: '12px 18px 14px', background: '#fff', borderBottom: '0.5px solid #D8E4EE', display: 'flex', alignItems: 'center', flexShrink: 0 }}>
              <span style={{ fontSize: '18px', fontWeight: 800, color: '#1A2740', flex: 1 }}>Milestones</span>
              <div style={{ padding: '6px 12px', background: '#fff', border: '1px solid #009DBB', borderRadius: '6px', fontSize: '10px', color: '#009DBB', fontWeight: 700, cursor: 'default' }}>Create Milestone</div>
            </div>

            {/* LIST */}
            <div style={{ padding: '14px 18px', display: 'flex', flexDirection: 'column', gap: '8px', overflow: 'hidden' }}>

              {/* MS1: Sprint */}
              <div className="ms-illu-ms-row ms-illu-ms1">
                <div className="ms-illu-ms-hdr">
                  ...
                  <div style={{ textAlign: 'center', minWidth: '52px' }}><div style={{ fontSize: '14px', fontWeight: 800, color: '#1A2740' }}>95%</div><div style={{ fontSize: '9px', color: '#8791AB' }}>Covered</div></div>
                  <div style={{ textAlign: 'center', minWidth: '52px' }}><div style={{ fontSize: '14px', fontWeight: 800, color: '#1A2740' }}>11</div><div style={{ fontSize: '9px', color: '#8791AB' }}>Days left</div></div>
                  <div style={{ textAlign: 'center', minWidth: '44px' }}><div style={{ fontSize: '14px', fontWeight: 800, color: '#1A2740' }}>2</div><div style={{ fontSize: '9px', color: '#8791AB' }}>Plans</div></div>
                  <div className="ms-illu-pill" style={{ background: '#009DBB', color: '#fff' }}>
                    Scheduled
                    <svg width="10" height="10" viewBox="0 0 10 10" fill="none"><path d="M2.5 3.5L5 6.5l2.5-3" stroke="white" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" /></svg>
                  </div>
                </div>
              </div>

              {/* MS2: Release — EXPANDED */}
              <div className="ms-illu-ms-row ms-illu-ms2" style={{ border: '0.5px solid #C2DDE8', flexShrink: 0 }}>
                <div className="ms-illu-ms-hdr" style={{ background: '#F8FBFD' }}>
                  <span className="ms-illu-chev" style={{ fontSize: '9px', color: '#009DBB', flexShrink: 0 }}>▶</span>
                  ...
                  <div style={{ textAlign: 'center', minWidth: '52px' }}><div style={{ fontSize: '14px', fontWeight: 800, color: '#1A2740' }}>62%</div><div style={{ fontSize: '9px', color: '#8791AB' }}>Covered</div></div>
                  <div style={{ textAlign: 'center', minWidth: '52px' }}><div style={{ fontSize: '14px', fontWeight: 800, color: '#1A2740' }}>5</div><div style={{ fontSize: '9px', color: '#8791AB' }}>Days left</div></div>
                  <div style={{ textAlign: 'center', minWidth: '44px' }}><div style={{ fontSize: '14px', fontWeight: 800, color: '#1A2740' }}>5</div><div style={{ fontSize: '9px', color: '#8791AB' }}>Plans</div></div>
                  <div className="ms-illu-pill" style={{ background: '#009DBB', color: '#fff' }}>
                    Testing
                    <svg width="10" height="10" viewBox="0 0 10 10" fill="none"><path d="M2.5 3.5L5 6.5l2.5-3" stroke="white" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" /></svg>
                  </div>
                ...
                {/* Expanded body */}
                <div className="ms-illu-expand">
                  <div className="ms-illu-col-hdr">
                    <span className="ms-illu-cl" style={{ flex: 1 }}>Test plan name</span>
                    <span className="ms-illu-cl" style={{ width: '100px', textAlign: 'center' }}>Covered / Total</span>
                    <span style={{ width: '24px', flexShrink: 0 }} />
                    <span className="ms-illu-cl" style={{ width: '112px', textAlign: 'left' }}>Coverage</span>
                  </div>
                  <div className="ms-illu-pr-row ms-illu-pr">
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', width: '112px' }}>
                      <div className="ms-illu-bar-track"><div className="ms-illu-bar-fill ms-illu-bf1" style={{ '--bar-w': '78%' } as React.CSSProperties} /></div>
                  ...
                  <div className="ms-illu-pr-row ms-illu-pr">
                    ...
                    <span style={{ width: '24px', flexShrink: 0 }} />
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', width: '112px' }}>
                      <div className="ms-illu-bar-track"><div className="ms-illu-bar-fill ms-illu-bf2" style={{ '--bar-w': '100%', background: '#00B884' } as React.CSSProperties} /></div>
                  ...
                  <div className="ms-illu-pr-row ms-illu-pr">
                    ...
                    <span style={{ width: '24px', flexShrink: 0 }} />
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', width: '112px' }}>
                      <div className="ms-illu-bar-track"><div className="ms-illu-bar-fill ms-illu-bf3" style={{ '--bar-w': '100%', background: '#00B884' } as React.CSSProperties} /></div>
                      <span style={{ width: '32px', fontSize: '11px', fontWeight: 700, color: '#1A2740', textAlign: 'right' }}>100%</span>
                    </div>
                  </div>
                  <div className="ms-illu-pr-row ms-illu-pr">
                    ...
                    <span style={{ width: '24px', flexShrink: 0 }} />
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', width: '112px' }}>
                      <div className="ms-illu-bar-track"><div className="ms-illu-bar-fill ms-illu-bf4" style={{ '--bar-w': '32%' } as React.CSSProperties} /></div>
                  ...
                  <div className="ms-illu-pr-row ms-illu-pr">
                    ...
                    <span style={{ width: '24px', flexShrink: 0 }} />
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', width: '112px' }}>
                      <div className="ms-illu-bar-track"><div className="ms-illu-bar-fill ms-illu-bf5" style={{ '--bar-w': '16%' } as React.CSSProperties} /></div>
                      <span style={{ width: '32px', fontSize: '11px', fontWeight: 700, color: '#1A2740', textAlign: 'right' }}>16%</span>
                    </div>
                  </div>
                  <div className="ms-illu-ctp" style={{ padding: '10px 16px 10px 32px', borderTop: '0.5px solid #EEF3F8' }}>
              ...
              {/* MS3: Plan */}
              <div className="ms-illu-ms-row ms-illu-ms3">
                <div className="ms-illu-ms-hdr">
                  <span style={{ fontSize: '9px', color: '#C3C8D5', flexShrink: 0 }}>▶</span>
                  <div style={{ width: '28px', height: '28px', borderRadius: '50%', border: '1.5px solid #C3C8D5', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                  ...
                  <div style={{ textAlign: 'center', minWidth: '52px' }}><div style={{ fontSize: '14px', fontWeight: 800, color: '#1A2740' }}>92%</div><div style={{ fontSize: '9px', color: '#8791AB' }}>Covered</div></div>
                  <div style={{ textAlign: 'center', minWidth: '52px' }}><div style={{ fontSize: '14px', fontWeight: 800, color: '#1A2740' }}>—</div><div style={{ fontSize: '9px', color: '#8791AB' }}>Days left</div></div>
                  <div style={{ textAlign: 'center', minWidth: '44px' }}><div style={{ fontSize: '14px', fontWeight: 800, color: '#1A2740' }}>3</div><div style={{ fontSize: '9px', color: '#8791AB' }}>Plans</div></div>
                  <div className="ms-illu-pill" style={{ background: '#fff', border: '1px solid #C8DDE6', color: '#5F7A8A' }}>
                    Completed
                    <svg width="10" height="10" viewBox="0 0 10 10" fill="none"><path d="M2.5 3.5L5 6.5l2.5-3" stroke="#8791AB" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" /></svg>
                  </div>
                </div>
              </div>

              {/* MS4: Feature */}
              <div className="ms-illu-ms-row ms-illu-ms4">
                <div className="ms-illu-ms-hdr">
                  <span style={{ fontSize: '9px', color: '#C3C8D5', flexShrink: 0 }}>▶</span>
                  <div style={{ width: '28px', height: '28px', borderRadius: '50%', border: '1.5px solid #C3C8D5', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                    <svg width="11" height="14" viewBox="0 0 11 14" fill="none">
                      <path d="M7 1L1.5 7.5H5.5L4 13L9.5 6.5H5.5L7 1Z" stroke="#8791AB" strokeWidth="1.15" strokeLinejoin="round" />
                    </svg>
                  </div>
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ fontSize: '12px', fontWeight: 700, color: '#1A2740' }}>Feature — Dark Mode Support</div>
                    <div style={{ fontSize: '9.5px', color: '#8791AB', marginTop: '1px' }}>12-15-2024 — 01-01-2025</div>
                  </div>
                  <div style={{ textAlign: 'center', minWidth: '52px' }}><div style={{ fontSize: '14px', fontWeight: 800, color: '#1A2740' }}>88%</div><div style={{ fontSize: '9px', color: '#8791AB' }}>Covered</div></div>
                  <div style={{ textAlign: 'center', minWidth: '52px' }}><div style={{ fontSize: '14px', fontWeight: 800, color: '#1A2740' }}>—</div><div style={{ fontSize: '9px', color: '#8791AB' }}>Days left</div></div>
                  <div style={{ textAlign: 'center', minWidth: '44px' }}><div style={{ fontSize: '14px', fontWeight: 800, color: '#1A2740' }}>4</div><div style={{ fontSize: '9px', color: '#8791AB' }}>Plans</div></div>
                  <div className="ms-illu-pill" style={{ background: '#fff', border: '1px solid #C8DDE6', color: '#5F7A8A' }}>
                    Completed
                    <svg width="10" height="10" viewBox="0 0 10 10" fill="none"><path d="M2.5 3.5L5 6.5l2.5-3" stroke="#8791AB" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" /></svg>
                  </div>
