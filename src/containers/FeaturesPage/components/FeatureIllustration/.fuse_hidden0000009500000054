...
export const AiAgentsIllustration: FC = () => {
  ...
  }, [isVisible, isTabVisible, isStatic, isMobileOrTablet]);
      ...
      <div ref={containerRef} className="ai-agents-illustration__inner">
        <div ref={canvasRef} className="ai-agents-illustration__canvas">
          ...
          <div className="ai-agents-illustration__mcp-hub" id="ai-illu-mcpHub">
            <svg
              className="ai-agents-illustration__hub-icon"
              width="30"
              height="30"
              viewBox="10 18 150 175"
              fill="none"
              aria-hidden="true"
            >
              <path
          ...
          >
            ...
            <span className="ai-agents-illustration__card-hint">
              Suggests test cases from specs &amp; requirements
            </span>
          </div>
          ...
          >
            <div className="ai-agents-illustration__card-head">
              <div className="ai-agents-illustration__card-icon">
                <svg width="15" height="15" viewBox="0 0 15 15" fill="none" aria-hidden="true">
                  ...
                  />
                  <path
                    d="M4.2 5.2h6.6M4.2 7.6h4.4M4.2 10h5.5"
                    stroke="#6A7EAA"
                    strokeWidth="1.15"
                    strokeLinecap="round"
                  />
            ...
            <span className="ai-agents-illustration__card-hint">
              Prioritizes tests by risk &amp; coverage gaps
            </span>
          </div>
          ...
          >
            ...
            <span className="ai-agents-illustration__card-hint">
              Detects flaky tests &amp; monitors runs in real time
            </span>
          </div>
          ...
          <div
            className="ai-agents-illustration__stage-card"
            id="ai-illu-sn4"
            style={{ left: '164px', top: '356px' }}
          >
            <div className="ai-agents-illustration__card-head">
              <div className="ai-agents-illustration__card-icon">
                <svg width="15" height="15" viewBox="0 0 15 15" fill="none" aria-hidden="true">
                  <path
                    d="M2 11l3.2-3.8 2.6 2.1 3.2-4.4L13.5 3"
                    stroke="#6A7EAA"
                    strokeWidth="1.15"
                    strokeLinecap="round"
                    strokeLinejoin="round"
            ...
            <span className="ai-agents-illustration__card-hint">
              Classifies failures &amp; surfaces root causes
            </span>
          </div>
          ...
          <div
            className="ai-agents-illustration__stage-card"
            id="ai-illu-sn5"
            style={{ left: '120px', top: '212px' }}
          >
            <div className="ai-agents-illustration__card-head">
              <div className="ai-agents-illustration__card-icon">
                <svg width="15" height="15" viewBox="0 0 15 15" fill="none" aria-hidden="true">
                  <path
                    d="M7.5 11C7.5 11 4 8.8 4 6C4 3.5 5.5 2 7.5 2C9.5 2 11 3.5 11 6C11 8.8 7.5 11 7.5 11Z"
                    stroke="#6A7EAA"
                    strokeWidth="1.15"
                    strokeLinejoin="round"
                  />
                  ...
                  <path
                    d="M5.5 10L4.6 13M9.5 10L10.4 13"
                    stroke="#6A7EAA"
                    strokeWidth="1.1"
                    strokeLinecap="round"
                  />
            ...
            <span className="ai-agents-illustration__card-hint">
              Makes go / no-go decision automatically
            </span>
          </div>
        </div>
      </div>
