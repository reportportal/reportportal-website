      ...
      <div className={classNames(getBlocksWith('__inner'), 'container')}>
        ...
        >
          ...
          >
            ...
            <path
              className="hiw-flow"
              d="M 500,0 L 500,16 L 108,16 Q 100,16 100,24 L 100,48"
              pathLength="100"
            />
            {/* Card 2 */}
            ...
            <path
              className="hiw-flow"
              d="M 500,0 L 500,16 L 892,16 Q 900,16 900,24 L 900,48"
              pathLength="100"
            />
          </g>
        </svg>
        ...
        <div className={getBlocksWith('__features-list')}>
          {HOW_IT_WORKS_STEPS.map(({ step, title, description }) => (
            <div key={step} className={getBlocksWith('__feature-item')}>
              <div className={getBlocksWith('__step-icon')}>{STEP_ICONS[step]}</div>
