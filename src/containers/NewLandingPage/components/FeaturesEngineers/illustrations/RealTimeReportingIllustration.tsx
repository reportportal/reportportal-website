      ...
      <div className="rt-canvas" ref={canvasRef}>
        <div className={classNames('window', { 'window--paused': spinnersPaused })} ref={inViewRef}>
          ...
          <div className="titlebar">
            <div
              style={{
                ...
                flexShrink: 0,
                border: '0.5px solid rgba(0,157,187,.2)',
              }}
            >
          ...
          <div className="col-hdr">
            ...
            <span className="cl" style={{ flex: 1 }}>
              Test
            </span>
            <span className="cl" style={{ width: 80, flexShrink: 0, textAlign: 'left' }}>
              Progress
            </span>
            <span className="cl" style={{ width: 28, flexShrink: 0, textAlign: 'right' }}>
              Time
            </span>
          </div>
            ...
            <div className="t-row" style={{ animationDelay: '.40s' }}>
              <div className="sc">
                <div
                  ...
                  style={{
                    animation:
                      'rt-spin .5s linear .40s infinite, rt-fadeOut .18s ease 1.20s forwards',
                  }}
                />
                <div
                  className="si p"
                  style={{ animation: 'rt-popIn .26s cubic-bezier(.34,1.56,.64,1) 1.20s both' }}
                >
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <span className="tname">loginTest</span>
                <span className="tmeta">AuthService · Security Suite</span>
              </div>
              <div className="rbar-track">
                <div
                  className="rbar-fill"
                  style={{ animation: 'rt-barPassed .80s ease .40s both' }}
                />
              </div>
            ...
            <div className="t-row" style={{ animationDelay: '.60s' }}>
              <div className="sc">
                <div
                  ...
                  style={{
                    animation:
                      'rt-spin .5s linear .60s infinite, rt-fadeOut .18s ease 1.80s forwards',
                  }}
                />
                <div
                  className="si f"
                  style={{ animation: 'rt-popIn .26s cubic-bezier(.34,1.56,.64,1) 1.80s both' }}
                >
                  <svg width="9" height="9" viewBox="0 0 9 9" fill="none">
                    <path
                      d="M1.8 1.8L7.2 7.2M7.2 1.8L1.8 7.2"
                      stroke="white"
                      strokeWidth="1.7"
                      strokeLinecap="round"
                    />
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <span className="tname">createUser</span>
                <span className="tmeta">UserAPI · Core Integration</span>
              </div>
              <div className="rbar-track">
                <div
                  className="rbar-fill"
                  style={{ animation: 'rt-barFailed 1.20s ease .60s both' }}
                />
              </div>
            ...
            <div className="t-row" style={{ animationDelay: '.80s' }}>
              <div className="sc">
                <div
                  ...
                  style={{
                    animation:
                      'rt-spin .5s linear .80s infinite, rt-fadeOut .18s ease 1.30s forwards',
                  }}
                />
                <div
                  className="si p"
                  style={{ animation: 'rt-popIn .26s cubic-bezier(.34,1.56,.64,1) 1.30s both' }}
                >
                  <svg width="10" height="8" viewBox="0 0 10 8" fill="none">
                    <path
                      d="M1 4L3.8 7L9 1"
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <span className="tname">tokenRefresh</span>
                <span className="tmeta">SessionManager · Auth</span>
              </div>
              <div className="rbar-track">
                <div
                  className="rbar-fill"
                  style={{ animation: 'rt-barPassed .50s ease .80s both' }}
                />
              </div>
            ...
            <div className="t-row" style={{ animationDelay: '1.00s' }}>
              <div className="sc">
                <div
                  ...
                  style={{
                    animation:
                      'rt-spin .5s linear 1.00s infinite, rt-fadeOut .18s ease 3.00s forwards',
                  }}
                />
                <div
                  className="si p"
                  style={{ animation: 'rt-popIn .26s cubic-bezier(.34,1.56,.64,1) 3.00s both' }}
                >
                  <svg width="10" height="8" viewBox="0 0 10 8" fill="none">
                    <path
                      d="M1 4L3.8 7L9 1"
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <span className="tname">queryOptimizer</span>
                <span className="tmeta">DataLayer · Database</span>
              </div>
              <div className="rbar-track">
                <div
                  className="rbar-fill"
                  style={{ animation: 'rt-barPassed 2.00s ease 1.00s both' }}
                />
              </div>
            ...
            <div className="t-row" style={{ animationDelay: '1.20s' }}>
              <div className="sc">
                <div
                  ...
                  style={{
                    animation:
                      'rt-spin .5s linear 1.20s infinite, rt-fadeOut .18s ease 2.80s forwards',
                  }}
                />
                <div
                  className="si p"
                  style={{ animation: 'rt-popIn .26s cubic-bezier(.34,1.56,.64,1) 2.80s both' }}
                >
                  <svg width="10" height="8" viewBox="0 0 10 8" fill="none">
                    <path
                      d="M1 4L3.8 7L9 1"
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <span className="tname">processTransaction</span>
                <span className="tmeta">PaymentGateway · Billing</span>
              </div>
              <div className="rbar-track">
                <div
                  className="rbar-fill"
                  style={{ animation: 'rt-barPassed 1.60s ease 1.20s both' }}
                />
              </div>
            ...
            <div className="t-row" style={{ animationDelay: '1.40s' }}>
              <div className="sc">
                <div
                  ...
                  style={{
                    animation:
                      'rt-spin .5s linear 1.40s infinite, rt-fadeOut .18s ease 1.60s forwards',
                  }}
                />
                <div
                  className="si s"
                  style={{ animation: 'rt-popIn .26s cubic-bezier(.34,1.56,.64,1) 1.60s both' }}
                >
                  <svg width="10" height="4" viewBox="0 0 10 4" fill="none">
                    <path d="M1.5 2H8.5" stroke="white" strokeWidth="2" strokeLinecap="round" />
                  </svg>
                </div>
              </div>
              <div style={{ flex: 1, minWidth: 0 }}>
                <span className="tname">sendNotification</span>
                <span className="tmeta">EmailService · Communications</span>
              </div>
              <div className="rbar-track">
                <div
                  className="rbar-fill"
                  style={{ animation: 'rt-barSkipped .20s ease 1.40s both' }}
                />
              </div>
              <span className="dur" style={{ color: '#C8DDE6' }}>
                —
              </span>
            </div>
            ...
            <div className="t-row" style={{ animationDelay: '1.60s' }}>
              <div className="sc">
                <div
                  ...
                  style={{
                    animation:
                      'rt-spin .5s linear 1.60s infinite, rt-fadeOut .18s ease 3.00s forwards',
                  }}
                />
                <div
                  className="si f"
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <span className="tname">generatePDF</span>
                <span className="tmeta">ReportEngine · Output</span>
              </div>
              <div className="rbar-track">
                <div
                  className="rbar-fill"
                  style={{ animation: 'rt-barFailed 1.40s ease 1.60s both' }}
                />
              </div>
          ...
          <div className="summary">
            ...
            <div
              style={{
                ...
                alignItems: 'center',
                gap: 8,
                animation: 'rt-fadeOut .25s ease forwards 3.10s',
              }}
            >
              <span
                style={{
                  ...
                  flexShrink: 0,
                  display: 'block',
                  animation: 'rt-pulse 1s ease 2 .4s',
                }}
              />
            ...
            <div
              style={{
                ...
                alignItems: 'center',
                opacity: 0,
                animation: 'rt-fadeIn .35s ease forwards 3.25s',
              }}
            >
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 5 }}>
                ...
                <div className="ss s">
                  <svg width="10" height="4" viewBox="0 0 10 4" fill="none">
                    <path d="M1.5 2H8.5" stroke="#784F00" strokeWidth="2" strokeLinecap="round" />
                  </svg>
                  1 Skipped
                </div>
              </div>
