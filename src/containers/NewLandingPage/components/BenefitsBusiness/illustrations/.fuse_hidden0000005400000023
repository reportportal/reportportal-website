...
export const AiTriageIllustration: FC = () => {
  ...
  useEffect(() => {
    ...
    t(() => {
      ...
      t(() => {
        const u = $('uMan');
        if (u || uMan) (u || uMan)!.style.animation = 'at-numIn .24s ease forwards';
      }, 60);
    }, ts + 120);
    ...
    t(() => {
      ...
      t(() => {
        const u = $('uAI');
        if (u) u.style.animation = 'at-numIn .24s ease forwards';
      }, 60);
    }, ts + 280);
      ...
      <div className="scene">
        ...
        <div className="tbl-wrap">
          <div className="tbl-hdr">
            ...
            <span className="th" style={{ textAlign: 'right' }}>
              Defect type
            </span>
          </div>
          ...
          <div className="t-row" id="r1">
            <span className="t-num" id="n1">
              1
            </span>
            <span className="t-name" id="nm1">
              Login — Session Error
            </span>
            <div className="log-cell" id="lc1">
              <span className="log-chip">Connection refused</span>
            </div>
            <div className="badge-cell" id="bc1">
              <span className="ai-star" id="sk1">
                ✦
              </span>
              <div className="badge-wrap">
                <div className="dbadge dt-ti" id="ti1">
                  TI
                </div>
                <div className="dbadge dt-si" id="nd1" style={{ opacity: 0 }}>
                  SI
                </div>
              </div>
            </div>
          ...
          <div className="t-row" id="r2">
            <span className="t-num" id="n2">
              2
            </span>
            <span className="t-name" id="nm2">
              API Auth — Token Check
            </span>
            <div className="log-cell" id="lc2">
              <span className="log-chip">401 Unauthorized</span>
            </div>
            <div className="badge-cell" id="bc2">
              <span className="ai-star" id="sk2">
                ✦
              </span>
              <div className="badge-wrap">
                <div className="dbadge dt-ti" id="ti2">
                  TI
                </div>
                <div className="dbadge dt-pb" id="nd2" style={{ opacity: 0 }}>
                  PB
                </div>
              </div>
            </div>
          ...
          <div className="t-row" id="r3">
            <span className="t-num" id="n3">
              3
            </span>
            <span className="t-name" id="nm3">
              Password Reset — Email Send
            </span>
            <div className="log-cell" id="lc3">
              <span className="log-none">no match</span>
            </div>
            <div className="badge-cell" id="bc3">
              <div className="badge-wrap">
                <div className="dbadge dt-ti">TI</div>
              </div>
            </div>
          </div>
          ...
          <div className="t-row" id="r4">
            <span className="t-num" id="n4">
              4
            </span>
            <span className="t-name" id="nm4">
              Test Suite — Init Step
            </span>
            <div className="log-cell" id="lc4">
              <span className="log-chip">NullPointerException</span>
            </div>
            <div className="badge-cell" id="bc4">
              <span className="ai-star" id="sk4">
                ✦
              </span>
              <div className="badge-wrap">
                <div className="dbadge dt-ti" id="ti4">
                  TI
                </div>
                <div className="dbadge dt-ab" id="nd4" style={{ opacity: 0 }}>
                  AB
                </div>
              </div>
            </div>
          ...
          <div className="t-row" id="r5">
            <span className="t-num" id="n5">
              5
            </span>
            <span className="t-name" id="nm5">
              Endpoint Load Test
            </span>
            <div className="log-cell" id="lc5">
              <span className="log-chip">Connection refused</span>
            </div>
            <div className="badge-cell" id="bc5">
              <span className="ai-star" id="sk5">
                ✦
              </span>
              <div className="badge-wrap">
                <div className="dbadge dt-ti" id="ti5">
                  TI
                </div>
                <div className="dbadge dt-si" id="nd5" style={{ opacity: 0 }}>
                  SI
                </div>
              </div>
            </div>
          ...
          <div className="t-row" id="r6">
            <span className="t-num" id="n6">
              6
            </span>
            <span className="t-name" id="nm6">
              Checkout — Payment Step
            </span>
            <div className="log-cell" id="lc6">
              <span className="log-none">no match</span>
            </div>
        ...
        <div className="bottom">
          ...
          <div className="time-area">
            <div className="t-side">
              <span className="t-side-lbl" id="lbl1">
                Without AI
              </span>
              <span className="t-big muted" id="tMan">
                6h 20m
              </span>
              <span className="t-unit" id="uMan">
                per launch
              </span>
            </div>
            ...
            <div className="t-side">
              <span className="t-side-lbl" id="lbl2">
                With AI
              </span>
              <span className="t-big vivid" id="tAI">
                1h 42m
              </span>
              <span className="t-unit" id="uAI">
                per launch
              </span>
            </div>
          </div>
