    ...
    >
      <div className="scene" ref={sceneRef}>
        ...
        >
          ...
          <path
            d="M88,86 L320,26 L552,86 L552,286 C552,396 438,466 320,496 C202,466 88,396 88,286 Z"
            fill={`url(#${uid}sf)`}
          />
          <path
            d="M110,92 L320,50 L530,92 L530,284 C530,378 426,442 320,472 C214,442 110,378 110,284 Z"
            fill={`url(#${uid}sf2)`}
            opacity=".5"
          />
          <path
        ...
        <div className="content">
            ...
            <div className="dep-front" id="df">
              <div className="dep-ico di-a">
                <svg width="18" height="18" viewBox="1 -2 20 20" fill="none">
                  <path
                    d="M4.5 13A4.5 4.5 0 015.8 5a5.5 5.5 0 0110.7 2.2A3.5 3.5 0 0115 14.5"
                    stroke="#009DBB"
                    strokeWidth="1.2"
                    strokeLinecap="round"
                  />
                  <path
                    d="M9 15v-5.5M7 11.5l2-2 2 2"
                    stroke="#009DBB"
                    strokeWidth="1.2"
                    strokeLinecap="round"
          ...
          {/* History title */}
          <div className="hist-title" id="htitle">
            History of Actions
          </div>
          ...
          <div className="rows-wrap">
            <div className="urow" id="ur1">
              ...
              <span className="u-action">
                Exported test report — <strong>Release 12.4</strong>
              </span>
            ...
            <div className="urow" id="ur2">
              ...
              <span className="u-action">
                Changed role: <strong>Viewer → Editor</strong> for Anna L.
              </span>
            ...
            <div className="urow" id="ur3">
              ...
              <span className="u-action">
                Ran manual launch — <strong>Auth &amp; Permissions</strong>
              </span>
