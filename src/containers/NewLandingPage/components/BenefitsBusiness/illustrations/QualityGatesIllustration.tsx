      ...
      <div className="scene">
        ...
        <div className="rules">
          <div className="rule-row" id="r1">
            <div className="light" id="l1">
              <svg width="11" height="11" viewBox="0 0 11 11" fill="none">
                <path className="ck" d="M2.5 5.5L4.5 7.5L8.5 3.5" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
            ...
            <div className="rule-val" id="rv1">73%</div>
          </div>
          ...
          <div className="rule-row" id="r2">
            ...
            <div className="rule-val" id="rv2">94%</div>
          </div>

          <div className="rule-row" id="r3">
            <div className="light" id="l3">
              <svg width="11" height="11" viewBox="0 0 11 11" fill="none">
                <path className="ck" id="ck3" d="M2.5 5.5L4.5 7.5L8.5 3.5" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
                <path className="dk" id="dk3" d="M3 5.5h5" strokeWidth="1.8" strokeLinecap="round" />
              </svg>
            </div>
            <div className="rule-body">
              ...
              <div className="rule-meta">
                {'Threshold ≤ 5% · '}
                <span id="nb-label" style={{ fontWeight: 700 }}>Non-blocking</span>
              </div>
            </div>
            <div className="rule-val" id="rv3">8%</div>
          </div>
          ...
          <div className="rule-row" id="r4">
            ...
            <div className="rule-val" id="rv4">85%</div>
          </div>
          ...
          <div className="rule-row" id="r5">
            ...
            <div className="rule-val" id="rv5">0</div>
          </div>
        </div>
        ...
        <div className="ai-row" id="aiRow">
          ...
          <div className="ai-text">
            Flaky test rate above threshold but non-blocking. 4 of 5 gates passed — no blockers, release window is clear.
          </div>
        </div>
